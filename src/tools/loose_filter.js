...
function getPositions(key, searchText, item) {
    return searchText
        .toLowerCase()
        .split('')
...
function addPostions(key, searchText, item) {
    return assoc('positions', getPositions(key, searchText, item), item)
}
...
export default function looseFilter(list, key, searchText) {
    ...
    const filteredList = list
        .map(addPostions.bind(null, key, searchText))
