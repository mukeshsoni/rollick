...
- [ ] Bug - changing component in styleguide does not refresh the props table
- [ ] Bug - the less files required in pp/shared components are not loaded as css anymore. They are directly loaded as the less file in the browser.
